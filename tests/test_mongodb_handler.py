...
class MongoDBHandlerTestCase(unittest.TestCase):
    ...
    def test_insert_item(self):
        ...
        doc = { "item": "SamSung Card", "related": "SamSung", "qty": 25, "tags": ["green", "red"], "accpunt": [10, 11]}
    ...
    def test_insert_items(self):
        print(inspect.stack()[0][3])
        docs = [
            { "item": "LG", "related": "LG", "qty": 25, "tags": ["red"], "accpunt": [10, 11]},
            { "item": "LG 화학", "related": "LG", "qty": 25, "tags": ["red"], "accpunt": [10, 11]}
        ]
    ...
    def test_find_item(self):
        print(inspect.stack()[0][3])
        doc = self.mongodb.find_item({"rekated": "LG"}, "stocklab_test", "corp_info")
        pprint(doc)
    ...
    def test_update_items(self):
        ...
        print("matched_count : " + str(result.modified_count))
