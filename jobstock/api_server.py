...
class CodeList(Resource):
    ...
    def get(self):
        ...
        for item in results:
            ...
            results_list.append(code_info)
        return {"code_list": results_list, "count": len(results_list)}, 200
...
class Price(Resource):
    ...
    def get(self, code):
        ...
        for item in results:
            price_info = {price_hname_to_eng[field]: result[field]
                          for field in result.keys() if field in price_hname_to_eng}
